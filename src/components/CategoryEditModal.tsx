...
const CategoryEditor: React.FC<CategoryEditorProps> = ({
    ...
    const [selectedId, setSelectedId] = useState<string | null>(safeData.length > 0 ? safeData[0].id : null);
    ...
    return (
        ...
        >
            <div
                className="flex flex-col h-full bg-white dark:bg-slate-800 rounded-lg shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-700
